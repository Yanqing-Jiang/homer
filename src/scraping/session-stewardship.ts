...
const SURFACES = {
  "amazon.vc": { origins: ["https://<vendor-portal-host>", "https://ara.amazon.com"], url: "https://<vendor-portal-host>/opportunity-explorer/explore" },
  "amazon.amc": { origins: ["https://<ads-portal-host>"], url: "https://<ads-portal-host>/marketing-cloud" },
} as const;
