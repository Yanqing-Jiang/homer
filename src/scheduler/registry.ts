...
const SCHEDULED_WITH_HANDLER_FILE: JobEntry[] = [
  ...
  { id: "job-scanner", name: "Job Scanner", kind: "internal", handler: "job_scanner", handlerFile: "job-scanner", expectedInSchedule: true, note: "discover→verify→rank; scans 3x/day, one daily midday top-10 digest email to hi@yanqing.app; management roles only; notify-only, no auto-apply" },
