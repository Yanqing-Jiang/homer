...
const SCHEDULED_WITH_HANDLER_FILE: JobEntry[] = [
  { id: "abvp-refresh", name: "<portal-dataset> + Search Rank Fortnightly Refresh", kind: "internal", handler: "abvp_refresh", handlerFile: "abvp-refresh", expectedInSchedule: true, note: "Tue 7 AM cadence + next_due_at fortnightly; 28-day portal window" },
  ...
  { id: "[redacted]", name: "Job Scanner", kind: "internal", handler: "job_scanner", handlerFile: "[redacted]", expectedInSchedule: true, note: "discover→verify→rank→email digest to <owner-email>; notify-only, no auto-apply" },
