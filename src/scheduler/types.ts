...
export interface ScheduledJobConfig {
  ...
  handler?: "ideas_review" | "overnight_review" | "idea_ingest" | "idea_dedup" | "session_summaries" | "session_harvester" | "memory_embeddings" | "memory_reindex" | "weekly_consolidation" | "memory_cleanup" | "ideas_explore" | "nightly_memory" | "homer_improvements" | "learning_engine" | "planning_reminder" | "morning_review" | "job_hunt_discover" | "job_hunt_daily_approval" | "job_hunt_weekly_report" | "job_hunt_email_monitor" | "job_hunt_followup" | "job_hunt_stalled_check" | "memory_git_commit" | "nightly_code_push" | "db_backup" | "outcome_tracker" | "preference_updater" | "content_scraper" | "idea_synthesizer" | "idea_deep_linker" | "archive_verify" | "health_check" | "context_bridge" | "architecture_updater" | "daemon_cleanup" | "session_maintenance" | "reminder_check" | "link_processor" | "overnight_youtube" | "harness_auto_improve" | "decision_journal" | "candidate_expiry";
