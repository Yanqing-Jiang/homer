...
function buildPilotCard(): MentorCard {
  return {
    ...
    move:
      "Pick ONE VP-adjacent person today. Send them the Shadow Data Pulse one-pager this afternoon — not for feedback, for recall. Subject line: \"Bypassing the 18-month data-foundation delay at <employer> — 2 min read.\"",
