...
export function registerIdeasRoutes(
  ...
  server.post("/api/ideas/:id/explore", async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    let activeFocusLine = "Wedding planning, external job search, <employer> analytics work, Homer automation";
...
## Who Yanqing Is
- Senior Analytics Manager at <employer> (Amazon Team), targeting $250K–$350K "Director of Agents" roles
