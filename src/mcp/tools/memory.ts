  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        claim_type: { type: "string", enum: ["fact", "decision", "preference", "hypothesis", "insight", "commitment", "question", "lesson"], description: "Type of claim (default: fact). hypothesis=unverified belief, insight=derived pattern, commitment=explicit promise." },
    ...
    case "memory_suggest": {
      ...
      try {
        ...
        const claimId = insertCandidate(sm.getDb(), {
          ...
          section: section ?? "",
          claimType: (claim_type ?? "fact") as "fact" | "decision" | "preference" | "hypothesis" | "insight" | "commitment" | "question" | "lesson",
